...
AUTH = environ.get("AUTH", default="brd-customer-hl_bddbed21-zone-scraping_browser1:4o16lku7tjwk")
TARGET_URL = environ.get("TARGET_URL", default="https://example.com")


def scrape(url=TARGET_URL):
    if AUTH == "brd-customer-hl_bddbed21-zone-scraping_browser1:4o16lku7tjwk":
        raise Exception(
    ...
    try:
        ...
        data = driver.execute_script("return arguments[0].map(el => el.innerText)", paragraphs)
